...
export function ReportPeriodNavigator({
  ...
  return (
    <div className="mb-4 flex flex-col gap-3 rounded-[18px] border border-[#e6dff8] bg-white px-4 py-3 shadow-[0_1px_0_rgba(17,24,39,0.03)] sm:flex-row sm:items-center sm:justify-between">
      <div>
