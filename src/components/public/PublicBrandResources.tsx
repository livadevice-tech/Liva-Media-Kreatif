            ...
            {selectedResource ? (
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden min-h-[500px]">
                <div className="p-8 md:p-10">
                  ...
                  <div 
                    className="prose prose-slate prose-p:leading-relaxed prose-headings:font-bold prose-a:text-blue-600 hover:prose-a:text-blue-700 max-w-none break-words whitespace-normal [&_*]:break-words [&_*]:whitespace-normal [&_img]:max-w-full [&_img]:h-auto [&_img]:rounded-xl [&_img]:shadow-sm"
