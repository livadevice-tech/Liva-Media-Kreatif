...
import { registerThrRoutes } from "./server/routes/thr";
...
async function runMigrations() {
  ...
  try {
    ...
    `, []);
    console.log('✅ Migration: tabel thr_periods dipastikan ada.');
  } catch (e: any) {
    console.warn('Migration thr_periods warning:', e?.message);
  }
  ...
  try {
    ...
    `, []);
    console.log('✅ Migration: tabel thr_items dipastikan ada.');
  } catch (e: any) {
