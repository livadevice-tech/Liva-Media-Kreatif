                ...
                <div className="mx-auto w-full max-w-[1600px] space-y-6 px-0 md:px-4 pb-12 sm:px-6 lg:px-8 mt-0 md:mt-6">
                  ...
                  <div className="w-full bg-[#fafafd] pb-12 overflow-x-hidden border border-slate-100 rounded-none md:rounded-3xl overflow-hidden shadow-sm pt-0 relative mt-2 text-slate-800 font-sans text-left min-h-screen">
                    <div className="w-full bg-white">
                      ...
                      availableShifts={getAvailableShiftsForBrand(
                        activeClientBrandId || undefined,
                        clientBrand,
                        brandPerformanceLogs,
                        shifts,
                      )}
                    ...
                    <div className="w-full">
                    {(clientReportingTab === "overview" || clientReportingTab === "live") && (
                      <React.Suspense
                        fallback={
                      ...
                      requestConfirm(
                        ...
                        async () => {
                          try {
                            ...
                            // Optional: loadInitialData() can be called here if we want to sync,
                              ...
                              >
                                ...
                                <div className="pt-2 flex items-center justify-end gap-2 border-t border-slate-100 mt-4">
                                  {scheduleForm.massSlots && scheduleForm.massSlots.length > 0 && (
                                    ...
                                    {scheduleForm.id && (!scheduleForm.massSlots || scheduleForm.massSlots.length === 0) && (
                                      <button
                                        type="button"
                                        onClick={() => {
                                           if (window.confirm('Apakah Anda yakin ingin menghapus jadwal ini?')) {
                                              schedulesApi.delete(scheduleForm.id).then(() => {
                                                  setSchedules(prev => prev.filter(s => s.id !== scheduleForm.id));
                                                  setIsScheduleModalOpen(false);
                                              }).catch(err => {
                                                  console.error(err);
                                        ...
                                        className="px-5 py-2.5 rounded-xl font-bold bg-red-50 hover:bg-red-100 text-red-600 transition-all cursor-pointer border-0"
                                      >
                                        Hapus
                                      </button>
                                    )}
                        ...
                        return (
                          ...
                          >
                            ...
                            <div 
                              ...
                              className={`relative bg-white border rounded-xl shadow-sm transition-all duration-150 flex flex-col p-3 cursor-pointer ${
                                isRowChecked 
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-x-2 gap-y-2 mt-1 pt-3 border-t border-dashed border-slate-200">
                                  ...
                                  <div className="flex flex-col">
                                    ...
                                    <span className="text-xs font-semibold text-slate-700 truncate">{item.platform}</span>
                                  </div>
                                  <div className="flex flex-col">
                                  ...
                                  <div className="flex flex-col">
                                    ...
                                    <span className="text-xs font-semibold text-slate-700 truncate">{item.studio || "-"}</span>
                                  </div>
                                </div>
                            </div>
                          </div>
                        ...
                        <div className="w-full bg-[#fafafd] pb-12 overflow-x-hidden pt-0 relative text-slate-800 font-sans text-left min-h-screen">
                          <div className="w-full bg-white">
                            <div className="px-4 pt-4 sm:px-6 lg:px-8 max-w-[1800px] mx-auto">
                              ...
                              availableShifts={getAvailableShiftsForBrand(
                                activeReportBrandId || undefined,
                                clientBrands.find((b) => b.id === activeReportBrandId),
                                brandPerformanceLogs,
                                shifts,
                              )}
                              operatorShiftFilters={operatorShiftFilters}
                          ...
                          {isUploadModalOpen && (
                            ...
                            >
                              ...
                              <div className="bg-white rounded-[24px] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-5xl w-full p-6 sm:p-8 text-left relative animate-scaleUp my-auto sm:my-4 z-10">
                                ...
                                {/* CLEAN FORM PENENTU BRAND & PLATFORM */}
                          ...
                          {(operatorReportingTab === "overview" || operatorReportingTab === "live" || operatorReportingTab === "metrics") && (
                            <React.Suspense
                              fallback={
                                <div className="px-6 sm:px-8 py-10 text-sm font-semibold text-slate-500 animate-pulse">
                                  Memuat panel reporting...
